...
public function insertar($nombre,$favorito,$idusuario){
	$sql="INSERT INTO salones (nombre,favorito,idusuario) VALUES ('$nombre','$favorito','$idusuario')";
	return ejecutarConsulta($sql);
}

public function editar($idgrupo,$nombre,$favorito,$idusuario){
	$sql="UPDATE salones SET nombre='$nombre',favorito='$favorito',idusuario='$idusuario'  
	WHERE idsalon='$idgrupo'";
	return ejecutarConsulta($sql);
}

public function anular($idgrupo){
	$sql="DELETE FROM salones WHERE idsalon='$idgrupo'"; 
	return ejecutarConsulta($sql);
}
...
public function mostrar_grupo($idgrupo){
	$sql="SELECT idsalon,nombre,favorito, idusuario  FROM salones WHERE idsalon='$idgrupo'";
	return ejecutarConsulta($sql);
}
...
public function listar(){
	$sql="SELECT g.idsalon,g.nombre,u.idusuario,u.nombre as usuario FROM salones g  INNER JOIN usuario u ON g.idusuario=u.idusuario ORDER BY g.idsalon DESC";
	return ejecutarConsulta($sql);
}
