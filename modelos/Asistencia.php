...
public function insertar($kind_id,$date_at,$alumn_id,$team_id){
	$sql="INSERT INTO asistencia (kind_id,date_at,alumn_id,salon_id) VALUES ('$kind_id','$date_at','$alumn_id','$team_id')";
	return ejecutarConsulta($sql);
}

public function editar($id,$kind_id,$date_at,$alumn_id,$team_id){
	$sql="UPDATE asistencia SET kind_id='$kind_id',date_at='$date_at',alumn_id='$alumn_id',salon_id='$team_id' 
	WHERE id='$id'";
	return ejecutarConsulta($sql);
}
...
public function verificar($date_at,$alumn_id,$team_id){
	$sql="SELECT * FROM asistencia WHERE date_at='$date_at' AND alumn_id='$alumn_id' AND salon_id='$team_id'";
