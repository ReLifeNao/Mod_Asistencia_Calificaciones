...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="nav-tabs-custom">
            ...
            ?>
              <li class="bg-green">
                 <a href="../vistas/vista_grupo_copy2.php?idsalon=<?php echo $_GET["idgrupo"]; ?>"><i class='fa fa-arrow-circle-left'></i> Volver</a>
              </li>
            <?php
            }else{
              ?>
              <li class="bg-green">
                 <a href="../vistas/vista_grupo.php?idsalon=<?php echo $_GET["idgrupo"]; ?>"><i class='fa fa-arrow-circle-left'></i> Volver</a>
              </li>
            <?php
            }
            ?>
