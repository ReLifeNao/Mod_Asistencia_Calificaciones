...
<div class="box-header with-border">
  ...
  <a  id="btnlistas" href="listasis.php?idgrupo=<?php echo $idgrupo; ?>" class="btn btn-info"><i class='fa fa-th-list'></i> Reportes</a>
  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Nombres(*):</label>
          <input type="hidden" id="idgrupo" name="idgrupo" value="<?php echo $_GET["idsalon"];?>">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">DNI(*)</label>
      <input class="form-control" type="text" name="dni" id="dni" maxlength="8" placeholder="DNI">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
