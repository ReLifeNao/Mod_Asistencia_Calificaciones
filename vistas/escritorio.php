...
<?php
  ...
  if($user_id==1){
    $rspta=$consulta->cantidadgruposAdmin($user_id);
  }else{
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
          ...
          <div class="<?php echo $colores[array_rand($colores)]; ?> collapsed-box">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <span data-toggle="tooltip" title="" class="badge" data-original-title="Cantidad de Estudiantes">
                  <?php 
                    $rsptag=$consulta->cantidadg($id_usuario,$idsalon);
            ...
            <div class="box-body" style="">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                    ...
                    <?php
                    $rsptas=$consulta->cantidadalumnos_porgrupo($id_usuario,$idsalon);
                    while ($reg=$rsptas->fetch_object()) {
                      
                   if (empty($reg->image)){
                    echo ' <img class="img-circle" src="../files/articulos/anonymous.png" height="50px" width="50px">';

                  }else echo '<img class="img-circle" src="../files/usuarios/'. $reg->image.'" height="50px" width="50px">';
                     } ?>
                  <!-- /.direct-chat-info -->
                  <!-- /.direct-chat-text -->
                </div>
            ...
            if($_SESSION["idusuario"]==1){
              ...
              <a href="vista_grupo_copy2.php?idsalon=<?php echo $idsalon; ?>" class="btn btn-default form-control" >Ir... <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            <?php
              }else{
                ?>
                <div class="box-footer" style="">
                <a href="vista_grupo.php?idsalon=<?php echo $idsalon; ?>" class="btn btn-default form-control" >Ir... <i class="fa fa-arrow-circle-right"></i></a>
              </div>
              <?php
            }
            ?>
