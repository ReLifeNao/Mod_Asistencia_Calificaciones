...
<div class="box-tools pull-right">
  <a href="../vistas/vista_grupo_copy2.php?idsalon=<?php echo $_GET["idgrupo"] ?>"><button class="btn btn-info"><i class='fa fa-arrow-circle-left'></i> Volver</button></a>
  </div>
  <?php
}else{
  ?>
  <div class="box-tools pull-right">
  <a href="../vistas/vista_grupo.php?idsalon=<?php echo $_GET["idgrupo"] ?>"><button class="btn btn-info"><i class='fa fa-arrow-circle-left'></i> Volver</button></a>
  </div>
  <?php 
}
?>
